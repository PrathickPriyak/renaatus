...
export function Select({ className, children, ...props }: SelectProps) {
  return (
    <select
      data-slot="select"
      className={cn(
        "h-12 w-full appearance-none rounded-sm border border-line bg-ink bg-[length:12px] bg-[position:right_1rem_center] bg-no-repeat px-4 pr-10 text-base text-cream outline-none md:text-sm",
